...
export async function generateMetadata({ params }) {
  ...
  return {
    title: subDept ? `${subDept.name} - Settings` : 'Sub-Department Settings',
    description: 'Sub-department configuration and settings'
  };
}

export default function SubDeptSettingsPage({ params }) {
