...
import { getAISystem } from '../registry/aiSystems.js';
import { logReviewAction, writeAuditLog } from '../ai/auditLog.js';

// In-memory review store (would be database in production)
let reviewStore = [];
...
export async function submitReview({
  ...
  if (decision === REVIEW_DECISION.BLOCK) {
    if (reviewerId === '002' || reviewerId === '004') {
